        ...
        <div className="min-h-screen bg-[#f8fafc] pb-12">
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm font-medium mt-1">Source, track, and hire the best talent for your teams.</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button 
                            ...
                            className="flex items-center gap-2 bg-indigo-600 text-white px-6 py-2.5 rounded-2xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100 font-bold text-sm"
                        >
                            <Plus size={18} />
                            Post New Job
                        </button>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {jobOpenings.map((job, idx) => (
                                <div key={idx} className="bg-white border border-slate-100 rounded-[2rem] p-6 hover:shadow-xl hover:shadow-slate-200/50 transition-all group cursor-pointer border-b-4 border-b-transparent hover:border-b-indigo-500">
                                    <div className="flex justify-between items-start mb-4">
                                    ...
                                    <h4 className="text-base font-bold text-slate-900 mb-1 group-hover:text-indigo-600 transition-colors">{job.title}</h4>
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-slate-50">
                                        ...
                                        <button className="px-4 py-2 bg-slate-50 text-slate-600 rounded-xl text-xs font-bold hover:bg-indigo-600 hover:text-white transition-all">
                                            Manage
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8">
                            <div className="flex items-center justify-between mb-8">
                                <h3 className="text-lg font-bold text-slate-900">New Applicants</h3>
                                ...
                                {recentApplications.map((app, i) => (
                                    <div key={i} className="flex items-center justify-between group cursor-pointer">
                                        <div className="flex items-center gap-4">
                                            <div className={`w-11 h-11 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center font-bold text-slate-600 text-sm shadow-sm`}>
                                                {app.name.split(' ').map(n => n[0]).join('')}
                                            </div>
                                            <div>
                                                <p className="text-sm font-bold text-slate-900 group-hover:text-indigo-600 transition-colors">{app.name}</p>
                                                <p className="text-[11px] font-medium text-slate-400">{app.position}</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <div className={`text-[10px] font-bold px-2 py-1 rounded-lg mb-1 ${
                            ...
                            <button className="w-full mt-8 py-3 bg-slate-50 text-slate-500 rounded-2xl text-xs font-bold hover:bg-indigo-50 hover:text-indigo-600 transition-all border border-transparent hover:border-indigo-100">
                                View Full Pipeline
                            </button>
                        </div>
            ...
            {showJobModal && (
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-in fade-in duration-300">
                    <div className="bg-white rounded-[3rem] w-full max-w-4xl max-h-[95vh] overflow-y-auto shadow-2xl border border-white/20">
                        <div className="p-10">
                            <div className="flex items-center justify-between mb-10">
                                <div>
                                    <h3 className="text-3xl font-black text-slate-900 tracking-tight">Post New Position</h3>
                                    <p className="text-sm font-medium text-slate-500 mt-1">Create a new job opening to attract qualified candidates.</p>
                                </div>
                                <button 
                            ...
                            <form className="space-y-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input 
                                                ...
                                                className="w-full p-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 font-bold text-slate-700"
                                                required
                                            />
                                        </div>
                                ...
                                {/* Job Details */}
                                <div className="space-y-6">
                                    <h4 className="text-lg font-bold text-slate-900">Job Details</h4>
                                    ...
                                    <div>
                                        ...
                                        <textarea 
                                            ...
                                            rows={4}
                                            className="w-full p-5 bg-slate-50 border-none rounded-3xl focus:ring-2 focus:ring-indigo-500 font-medium text-slate-700 resize-none"
                                            required
                                        />
                                    </div>
                                ...
                                <div className="bg-indigo-50 border border-indigo-200 rounded-2xl p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-indigo-900 mb-2">Posting Guidelines</p>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                    ...
                                    <button 
                                        ...
                                        className="flex-[2] px-8 py-4 bg-indigo-600 text-white rounded-2xl hover:bg-indigo-700 font-bold transition-all shadow-xl shadow-indigo-100 flex items-center justify-center gap-3 order-1 sm:order-2"
                                    >
                                        <Send size={18} />
                                        Post Job Opening
                                    </button>
