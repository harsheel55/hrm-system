            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm font-medium mt-1">Manage your work logs and shift compliance.</p>
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        <button className="flex items-center px-4 py-2 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 text-slate-700 text-sm font-bold shadow-sm transition-all">
                            <Filter size={16} className="mr-2" />
                            Filters
                        </button>
                        <button className="flex items-center px-4 py-2 bg-slate-900 text-white rounded-xl hover:bg-slate-800 transition-all shadow-lg shadow-slate-200 text-sm font-bold">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    {attendanceStats.map((stat, i) => (
                        <div key={i} className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all cursor-pointer group">
                                ...
                                <table className="w-full text-left">
                                    <thead>
                                        <tr className="bg-slate-50/50">
                                            <th className="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider">Date & Type</th>
                                            <th className="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider text-center">Check-In</th>
                                            <th className="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider text-center">Check-Out</th>
                                            <th className="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider">Duration</th>
                                    ...
                                    <tbody className="divide-y divide-slate-50">
                                        {attendanceData.map((record, i) => (
                                            <tr key={i} className="hover:bg-slate-50/80 transition-colors group">
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-[11px] font-medium text-slate-500">{record.type}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4">
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className="text-sm font-mono font-bold text-slate-600">{record.hours}</span>
                                                </td>
                                                <td className="px-6 py-4">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-900 rounded-[2rem] p-8 text-white relative overflow-hidden group">
                            <div className="relative z-10">
                                ...
                                <button className="w-full mt-3 py-3 bg-slate-800 text-white rounded-2xl font-bold text-sm hover:bg-slate-700 transition-all border border-slate-700">
                                    Regularize Logs
                                </button>
                            </div>
                        ...
                        <div className="bg-white rounded-[2rem] shadow-sm border border-slate-200/60 p-6">
                            <h4 className="font-bold text-slate-900 mb-6 flex items-center justify-between">
                                Monthly Summary
                                <span className="text-[10px] text-slate-400 bg-slate-50 px-2 py-1 rounded-md italic">Updated 1h ago</span>
                            </h4>
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                                    <div className="flex items-center gap-3">
                                        <div className="w-2 h-8 bg-green-500 rounded-full"></div>
                                        <p className="text-sm font-bold text-slate-700">Days Present</p>
                                    </div>
                                    <span className="text-lg font-mono font-bold">22</span>
                                </div>
                                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                                    <div className="flex items-center gap-3">
                                        <div className="w-2 h-8 bg-amber-400 rounded-full"></div>
                                        <p className="text-sm font-bold text-slate-700">Leave / Sick</p>
                                    </div>
