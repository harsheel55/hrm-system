            ...
            <div key={employee.id} className="select-none">
                <div 
                    className={`flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 cursor-pointer transition-all group ${
                        isSearchMatch ? 'bg-blue-50 border border-blue-200' : ''
                    }`}
                    onClick={() => {
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                            ...
                            {isSearchMatch && <span className="text-xs bg-blue-100 text-blue-600 px-2 py-0.5 rounded-full">Match</span>}
                        </div>
                        ...
                        <div className="flex items-center gap-3 mt-1">
                            ...
                            {employee.reports > 0 && (
                                <span className="text-xs text-blue-600 font-medium">{employee.reports} reports</span>
                            )}
                        </div>
                    </div>
                ...
                {hasChildren && isExpanded && (
                    <div className="ml-8 mt-2 space-y-1 border-l-2 border-slate-100 pl-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="bg-blue-100 text-blue-700 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">Organization</span>
                        </div>
                        <h1 className="text-3xl font-black text-slate-900 tracking-tight">Organization Tree</h1>
                        <p className="text-slate-500 text-sm font-medium mt-1">Visualize your company hierarchy and team structure.</p>
                    </div>
                    ...
                    <div className="space-y-6">
                        {selectedEmployee ? (
                            <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8">
                                ...
                                <div className="text-center mb-6">
                                    ...
                                    <div className="flex items-center justify-center gap-1 mt-2">
                                        ...
                                        <span className="text-xs text-slate-400">{selectedEmployee.department}</span>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm font-medium text-slate-700">{selectedEmployee.email}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm font-medium text-slate-700">{selectedEmployee.phone}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm font-medium text-slate-700">{selectedEmployee.location}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm font-medium text-slate-700">{new Date(selectedEmployee.joinDate).toLocaleDateString()}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm font-medium text-slate-700">{selectedEmployee.reports} direct reports</p>
                                        </div>
                                    </div>
                                </div>

                                <div className="mt-6 grid grid-cols-2 gap-3">
                                    <button className="py-2 px-4 bg-blue-600 text-white rounded-xl text-sm font-bold hover:bg-blue-700 transition-all">
                                        Send Message
                                    </button>
                                    <button className="py-2 px-4 bg-slate-100 text-slate-700 rounded-xl text-sm font-bold hover:bg-slate-200 transition-all">
                                        View Profile
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden">
                                <Users className="mb-4 text-slate-400" size={32} />
                        ...
                        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center p-4 bg-slate-50 rounded-xl">
                                    <span className="text-sm font-bold text-slate-600">Total Employees</span>
                                    <span className="text-lg font-black text-blue-600">24</span>
                                </div>
                                <div className="flex justify-between items-center p-4 bg-slate-50 rounded-xl">
                                    <span className="text-sm font-bold text-slate-600">Departments</span>
                                    <span className="text-lg font-black text-emerald-600">6</span>
                                </div>
                                <div className="flex justify-between items-center p-4 bg-slate-50 rounded-xl">
                                    <span className="text-sm font-bold text-slate-600">Avg. Team Size</span>
                                    <span className="text-lg font-black text-amber-600">4.2</span>
                                </div>
                            </div>
                        </div>
                    </div>
