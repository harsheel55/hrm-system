            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm font-medium">Real-time insights into your organization's human capital.</p>
                    </div>
                    
                    <div className="flex items-center gap-3">
                        <button className="flex items-center px-4 py-2.5 bg-white border border-slate-200 rounded-2xl hover:bg-slate-50 text-slate-700 text-sm font-bold shadow-sm transition-all">
                            <Calendar size={18} className="mr-2 text-slate-400" />
                            Last 12 Months
                        </button>
                        <button className="flex items-center px-6 py-2.5 bg-slate-900 text-white rounded-2xl hover:bg-slate-800 transition-all shadow-lg shadow-slate-200 text-sm font-bold">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
                    ...
                    <div className="lg:col-span-2 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8">
                        <div className="flex items-center justify-between mb-10">
                            <div>
                                <h3 className="text-lg font-bold text-slate-900">Growth Velocity</h3>
                            ...
                            {hiringData.map((h, i) => (
                                <div key={i} className="flex flex-col items-center gap-3 w-full group">
                                    <div className="relative w-full flex items-end justify-center h-full">
                                        ...
                                        <div className="absolute inset-0 bg-slate-50/50 rounded-t-lg mx-1"></div>
                                        {/* Value Bar */}
                                        <div 
                    ...
                    <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8">
                            ...
                            {departmentData.map((dept, i) => (
                                <div key={i} className="group cursor-default">
                                    <div className="flex justify-between text-xs font-bold mb-2">
                                        <span className="text-slate-700 group-hover:text-indigo-600 transition-colors">{dept.name}</span>
                        ...
                        <div className="mt-8 p-4 bg-indigo-50 rounded-2xl flex items-center gap-3">
                            ...
                            <p className="text-[11px] font-bold text-indigo-700 leading-tight">Engineering has grown 18% since January Q1.</p>
                        </div>
                    </div>
                </div>

                {/* --- Quick Actions Bar --- */}
                <div className="bg-slate-900 rounded-[2rem] p-4 flex flex-col md:flex-row items-center gap-4 mb-10">
                ...
                <div className="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-10 relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
                        <h3 className="text-2xl font-black text-slate-900 tracking-tight">2024 Performance Summary</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        <div className="flex flex-col items-center md:items-start">
                            ...
                            <p className="text-sm font-bold text-slate-900 uppercase tracking-widest">New Talents Hired</p>
                        ...
                        <div className="flex flex-col items-center md:items-start border-y md:border-y-0 md:border-x border-slate-100 py-10 md:py-0 md:px-10">
                            <div className="text-5xl font-black text-emerald-500 mb-2 tracking-tighter">94%</div>
                            <p className="text-sm font-bold text-slate-900 uppercase tracking-widest">Employee Retention</p>
                        ...
                        <div className="flex flex-col items-center md:items-start">
                            ...
                            <p className="text-sm font-bold text-slate-900 uppercase tracking-widest">Avg. Service Tenure</p>
